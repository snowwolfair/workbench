...
@Component({
  ...
  imports: [NzCardModule, NzGridModule, NzSliderModule, FormsModule, NzInputNumberModule],
...
export class ThreeViewComponent implements OnInit, AfterViewInit {
  ...
  updateScene() {
    ...
    this.cube.geometry = new THREE.BoxGeometry(this.geometryValue.x, this.geometryValue.y, this.geometryValue.z);
    this.cube.position.set(this.cubeValue.x, this.cubeValue.y, this.cubeValue.z);

    // 更新相机位置
    this.camera = new THREE.PerspectiveCamera(
      this.cameraPerspective.fov,
      this.width / this.height,
      this.cameraPerspective.near,
      this.cameraPerspective.far
    );
